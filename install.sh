...
#########################
CDNF="https://raw.githubusercontent.com/daneshswara29/v7/main"
REPO="https://raw.githubusercontent.com/myridwan/scriptvps/main/"
###
...
echo ""
wget -q https://raw.githubusercontent.com/daneshswara29/v7/main/dependencies.sh;chmod +x dependencies.sh;./dependencies.sh
rm dependencies.sh
clear
...
sleep 2
clear
wget https://raw.githubusercontent.com/daneshswara29/v7/main/ssh/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
#Instal Xray
echo -e "$green[INFO]$NC Install XRAY!"
sleep 2
clear
wget https://raw.githubusercontent.com/daneshswara29/v7/main/xray/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
clear
echo -e "$green[INFO]$NC Install SET-BR!"
wget https://raw.githubusercontent.com/daneshswara29/v7/main/backup/set-br.sh && chmod +x set-br.sh && ./set-br.sh
clear
echo -e "$green[INFO]$NC Install WEBSOCKET!"
wget https://raw.githubusercontent.com/daneshswara29/v7/main/websocket/insshws.sh && chmod +x insshws.sh && ./insshws.sh
clear
wget https://raw.githubusercontent.com/daneshswara29/v7/main/websocket/nontls.sh && chmod +x nontls.sh && ./nontls.sh
clear
echo -e "$green[INFO]$NC Download Extra Menu"
sleep 2
wget https://raw.githubusercontent.com/daneshswara29/v7/main/update/update.sh && chmod +x update.sh && ./update.sh
rm -f update.sh
clear
echo -e "$green[INFO]$NC INSTALL SLOWDNS"
sleep 2
wget https://raw.githubusercontent.com/daneshswara29/v7/main/slowdns/installsl.sh && chmod +x installsl.sh && ./installsl.sh
clear
echo -e "\e[33m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
...
history -c
serverV=$( curl -sS https://raw.githubusercontent.com/daneshswara29/v7/main/version  )
...
echo " "
echo "=====================-[ AutoScript D_swara-Project ]-===================="
echo ""
echo "------------------------------------------------------------"
echo ""
echo ""
...
echo ""  | tee -a log-install.txt
echo "   >>> WhatsApp : +6282380835972 (Text Only)"  | tee -a log-install.txt
echo "   >>> Telegram : t.me/D_swara"  | tee -a log-install.txt
echo ""
echo ""
echo "------------------------------------------------------------"
echo ""
