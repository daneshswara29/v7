#!/bin/bash
# =========================================
BOT="https://raw.githubusercontent.com/daneshswara29/vu/main/"
UPDATE="https://raw.githubusercontent.com/daneshswara29/v7/main/update/update.sh"
...
echo -e "  ${BLUE}• ${GREEN}Developer           ${NC}: D_swara ${NC}"
echo -e "$COLOR1┌────────────────────────────────────────────────────────────┐${NC}"
